...
# transforms. It's fairly slow and should be parallelized, but it
# works. If you have a significant dataset, just start this and go
# make some coffee. cv2 is fairly fast, but the 24 different augments
...
if __name__ == "__main__":
    image_list = [x for x in os.listdir("./images")]
    ...
    for image_path, mask_path in zip(image_list, mask_list):
        ...
        mask = cv2.imread(f"./masks/{mask_path}")
