...
class Config():
    def __init__(self) -> None:
        ...
        self.mixed_precision = ['no', 'fp16', 'bf16', 'fp8'][0] # 2. FP8 doesn't show acceleration in the torch.compile mode.
        ...
        self.sys_home_dir = [os.path.expanduser('~'), './'][1]   # Default, custom
