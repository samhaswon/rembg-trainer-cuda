...
class BinarySegFormer(nn.Module):
    """SegFormer encoder with a 1-logit head for binary segmentation.

    Parameters
    ----------
    backbone
        Hugging Face SegformerModel name, e.g. 'nvidia/segformer-b2-finetuned-ade-512-512'.
    """

    def __init__(self, backbone: str = "nvidia/segformer-b2-finetuned-ade-512-512", size: int = 1024,
